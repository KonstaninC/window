...
/* harmony import */ var _modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/changeModalState */ "./src/js/modules/changeModalState");
...
/***/ "./src/js/modules/changeModalState":
/*!*****************************************!*\
  !*** ./src/js/modules/changeModalState ***!
  \*****************************************/
...
var timer = function timer(id, deadline) {
  var getTimeRemaining = function getTimeRemaining(endTime) {
    var time = Date.parse(endTime) - Date.parse(new Date()),
        // при создании объекта new Date() мы создаём
    // данные о текущем времени до миллисекунды.
